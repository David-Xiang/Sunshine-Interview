...
public class NetworkUtils {
    ...
    public static boolean uploadHashCode(String filePath, String hashCode){
        // TBD
        URL url = buildUrl("/uploadHashCode");
        ...
        try {
             ...
             * filename是文件的名字，包含后缀名的 比如:abc.png
             */
            sb.append("Content-Disposition: form-data; filePath=" + "\"" + filePath +  "\"" +"; hashCode=" + "\"" + hashCode + "\"" +LINE_END);
            sb.append("Content-Type: application/octet-stream; charset="+UP_CHARSET+LINE_END);
            sb.append(LINE_END);
            dos.write(sb.toString().getBytes());
